...
<div>
    ...
    <div class="flex flex--middle mb8">
        ...
        <a href="tel:${location.telefon}" target="_blank" rel="noreferrer" class="link--reverse gtm-map-tel gtm-contact">
            ${location.telefon}
        </a>
    </div>
    ` : ``)
    ...
    <div class="flex flex--middle mb8">
        ...
        <a href="mailto:${location.email}" target="_blank" rel="noreferrer" class="link--reverse gtm-map-email gtm-contact">
            ${location.email}
        </a>
    </div>
    ` : ``)
