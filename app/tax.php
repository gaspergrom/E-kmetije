...
add_action('init', function() {
    register_taxonomy('regije',     ['ponudniki', 'turisticni-ponudniki'], include "tax/regije.php");
    register_taxonomy('obcine',     ['ponudniki', 'turisticni-ponudniki'], include "tax/obcine.php");
